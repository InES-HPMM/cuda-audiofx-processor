...
class IGraphNode {
   ...
   public:
    ...
    virtual void updateExec(cudaGraphExec_t procGraphExec) = 0;
...
class IKernelNode : public IGraphNode {
   public:
    ...
    virtual void updateExecKernelParamAt(int index, void* param, cudaGraphExec_t procGraphExec = nullptr) = 0;
    virtual void updateKernelParamAt(int index, void* param) = 0;
};
...
class IMemCpyNode : public IGraphNode {
   public:
    ...
    virtual void updateSrcPtr(const void* src) = 0;
    virtual void updateDstPtr(void* dst) = 0;
    virtual void updateExecSrcPtr(const void* src, cudaGraphExec_t procGraphExec = nullptr) = 0;
    virtual void updateExecDstPtr(void* dst, cudaGraphExec_t procGraphExec = nullptr) = 0;
